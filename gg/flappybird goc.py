...
G = 0.5
SPEEDFLY = -8
BIRDIMG = pygame.image.load('gNew folder/gg/img/bird.png')
...
DISTANCE = 200
COLUMNSPEED = 2
COLUMNIMG = pygame.image.load('New folder/gg/img/column.png')

BACKGROUND = pygame.image.load('New folder/gg/img/background.png')
...
pygame.display.set_caption('Flappy panh')
...
def gameStart(bird):
    ...
    headingSuface = font.render('panh', True, (255, 0, 0))
    headingSize = headingSuface.get_size()
    
    font = pygame.font.SysFont('consolas', 20)
    commentSuface = font.render('bấm để bắt đầu', True, (0, 0, 0))
...
def gameOver(bird, columns, score):
    font = pygame.font.SysFont('consolas', 60)
    headingSuface = font.render('ez', True, (255, 0, 0))
    headingSize = headingSuface.get_size()
    
    font = pygame.font.SysFont('consolas', 20)
    commentSuface = font.render('space để chơi lại', True, (0, 0, 0))
    commentSize = commentSuface.get_size()
